...
gpui.mount(()=>gpui.column('structured-fixture',[
  ...
  kit.SchemaForm('form',{fields:[{name:'title',kind:'text',label:'Caller title',placeholder:'Enter fixture title',required:true},{name:'count',kind:'integer',label:'Count',min:1,max:19},{name:'enabled',kind:'boolean',label:'Enabled'},{name:'choice',kind:'enum',choices:[{id:'first',label:'First choice'},{id:'second',label:'Second choice'}]},{name:'files',kind:'files',label:'Files (host policy not installed)'}]}),
]));
