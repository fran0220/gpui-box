...
gpui.mount(()=>gpui.column('data-fixture',[
  ...
  kit.DiagnosticsList('diagnostics',{state:'ready',diagnostics:[{id:'warning',severity:'warning',location:'Fixture document · 8:3',message:'Caller-owned warning; no file is opened.'}],visibleRows:1}),
