...
export interface DataFactories {
  ...
  Tree(id:string,props:DataSized&{nodes:NativeTreeNode[];disabled?:boolean;loading?:boolean;failure?:string;visibleRows?:number;expanded?:string[];selected?:string;reorderable?:boolean;empty?:DataEmpty},events?:{select?(id:string):void;toggle?(v:{id:string;expanded:boolean}):void;move?(v:DataDrop):void},slots?:KitSlots,predicates?:{accepts?(intent:DataDrop):boolean|Promise<boolean>}):KitNode;
