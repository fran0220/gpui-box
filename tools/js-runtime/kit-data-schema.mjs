...
const schemas={
  ...
  Tree:{props:{$defs:{TreeNode:tree()},...o({disabled:b,loading:b,failure:s,visibleRows:count,nodes:a({$ref:'TreeNode'}),expanded:a(id),selected:id,reorderable:b},['nodes'])},events:{select:id,toggle,move:drop},predicates:{accepts:drop},slots:surfaceSlots},
